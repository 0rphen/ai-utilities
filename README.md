...
| [`front-guidelines`](skills/front-guidelines/) | Framework-agnostic frontend architecture rules — feature-first (screaming) structure, repository/datasource data layer, hard smart/dumb component split, and centralized, token-driven styling. |
